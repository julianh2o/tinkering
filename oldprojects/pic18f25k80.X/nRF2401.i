...
#line 1 "./nRF2401.h"
#line 1 "./nRF2401_config.h"
#line 1 "/Applications/microchip/mplabc18/v3.40/bin/../h/p18f25k80.h"

#line 5 "/Applications/microchip/mplabc18/v3.40/bin/../h/p18f25k80.h"
 


#line 9 "/Applications/microchip/mplabc18/v3.40/bin/../h/p18f25k80.h"
...
#line 6986 "/Applications/microchip/mplabc18/v3.40/bin/../h/p18f25k80.h"
 
#line 6988 "/Applications/microchip/mplabc18/v3.40/bin/../h/p18f25k80.h"
#line 6989 "/Applications/microchip/mplabc18/v3.40/bin/../h/p18f25k80.h"


#line 6992 "/Applications/microchip/mplabc18/v3.40/bin/../h/p18f25k80.h"
 
#line 6994 "/Applications/microchip/mplabc18/v3.40/bin/../h/p18f25k80.h"
#line 6995 "/Applications/microchip/mplabc18/v3.40/bin/../h/p18f25k80.h"
#line 6996 "/Applications/microchip/mplabc18/v3.40/bin/../h/p18f25k80.h"
#line 6997 "/Applications/microchip/mplabc18/v3.40/bin/../h/p18f25k80.h"

#line 6999 "/Applications/microchip/mplabc18/v3.40/bin/../h/p18f25k80.h"
#line 7000 "/Applications/microchip/mplabc18/v3.40/bin/../h/p18f25k80.h"
#line 7001 "/Applications/microchip/mplabc18/v3.40/bin/../h/p18f25k80.h"
#line 7002 "/Applications/microchip/mplabc18/v3.40/bin/../h/p18f25k80.h"
#line 7003 "/Applications/microchip/mplabc18/v3.40/bin/../h/p18f25k80.h"


#line 7007 "/Applications/microchip/mplabc18/v3.40/bin/../h/p18f25k80.h"
 
#line 7009 "/Applications/microchip/mplabc18/v3.40/bin/../h/p18f25k80.h"


#line 7012 "/Applications/microchip/mplabc18/v3.40/bin/../h/p18f25k80.h"
#line 1 "./nRF2401_config.h"



#line 5 "./nRF2401_config.h"
#line 6 "./nRF2401_config.h"
#line 7 "./nRF2401_config.h"
#line 8 "./nRF2401_config.h"
#line 9 "./nRF2401_config.h"
#line 10 "./nRF2401_config.h"

#line 12 "./nRF2401_config.h"
#line 13 "./nRF2401_config.h"
#line 14 "./nRF2401_config.h"


#line 17 "./nRF2401_config.h"
#line 18 "./nRF2401_config.h"

#line 20 "./nRF2401_config.h"
#line 21 "./nRF2401_config.h"
#line 22 "./nRF2401_config.h"
#line 23 "./nRF2401_config.h"
#line 24 "./nRF2401_config.h"

#line 26 "./nRF2401_config.h"
...
unsigned char TX_ADDRESS[5 ] = {0x34,0x43,0x10,0x10,0x00}; 
...
unsigned char nrf_send(unsigned char * tx_buf, unsigned char * rx_buf) {
    ...
    nrf_SPI_RW_Reg(0x20  + 0x07 , status);	
    nrf_SPI_Write_Buf(0xA0 ,tx_buf,32 ); 
    ...
    status = nrf_getStatus();
    if(status & 0x40 ) {
        nrf_SPI_RW_Reg(0x20  + 0x07 , 0x40 );		
        nrf_SPI_Read_Buf(0x61 ,rx_buf,2 );
...
void nrf_send_noack(unsigned char * tx_buf, unsigned char * rx_buf) {
    ...
    status = nrf_getStatus();
    nrf_SPI_RW_Reg(0x20  + 0x07 , status);	
    nrf_SPI_Write_Buf(0xB0 ,tx_buf,32 ); 
...
unsigned char nrf_receive(unsigned char * tx_buf, unsigned char * rx_buf) {
    ...
    nrf_SPI_RW_Reg(0xE1 ,0);
    nrf_SPI_Write_Buf(0xA8 ,tx_buf,2 );

    

    status = nrf_getStatus();
    ffstat = nrf_SPI_Read(0x17 );

    if(((status & 0x40 ))||(!(ffstat & 0x01))) {
        ffstatcount = 0;
        while((ffstatcount++ < 4) && ((ffstat & 0x01) == 0)) {
            
            nrf_SPI_Read_Buf(0x61 ,rx_buf,32);
            ffstat = nrf_SPI_Read(0x17 );
        }
        nrf_SPI_RW_Reg(0x20  + 0x07 , 0x70);	
        return 0x01 ;
    } else {
        return 0x00 ;
    }
...
void nrf_init(void) {
    ...
    nrf_SPI_Write_Buf(0x20  + 0x10 , TX_ADDRESS, 5 );    
    nrf_SPI_Write_Buf(0x20  + 0x0A , TX_ADDRESS, 5 ); 

    nrf_SPI_RW_Reg(0x50 ,0x73);					
    nrf_SPI_RW_Reg(0x20  + 0x1D , 0x06);	        	
    nrf_SPI_RW_Reg(0x20  + 0x1C ,     0b111111);		
    nrf_SPI_RW_Reg(0x20  + 0x01 ,     0b111111);            
    nrf_SPI_RW_Reg(0x20  + 0x02 , 0b0001);              
    nrf_SPI_RW_Reg(0x20  + 0x04 , 0x12); 
    nrf_SPI_RW_Reg(0x20  + 0x05 , 40);        
    nrf_SPI_RW_Reg(0x20  + 0x11 , 32 ); 
    
    nrf_SPI_RW_Reg(0x20  + 0x06 , 0x07);   
    ...
    nrf_SPI_RW_Reg(0x20  + STATUS, status);
...
void nrf_setRxAddr(char pipe, char addr) {
    ...
    Delay10TCYx(3);
    TX_ADDRESS[0] = addr;
    nrf_SPI_Write_Buf(0x20  + 0x0A  + pipe, TX_ADDRESS, 5 );
    Delay10TCYx(3);
    PORTCbits.RC0  = 1 ;
}
...
char nrf_enablePipe(char pipe) {
    ...
    PORTCbits.RC0  = 0 ;
    Delay10TCYx(3);
    pipeStatus = nrf_SPI_Read(0x02 );
    pipeStatus = pipeStatus | (0b1 << pipe);
    nrf_SPI_RW_Reg(0x20  + 0x02 , pipeStatus);
    nrf_SPI_RW_Reg(0x20  + 0x11  + pipe, 32 );
    Delay10TCYx(3);
    PORTCbits.RC0  = 1 ;
    return pipeStatus;
}
